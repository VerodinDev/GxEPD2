...
// Pervasive Displays EM027AS012
// tested with Embedded Artists' 2.7" E-Paper Display, rev A

#ifndef _GxEPD2_270_PD_H_
#define _GxEPD2_270_PD_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_270_PD : public GxEPD2_EPD
{
  public:
    // attributes
    // TODO: width and height seem switched, verify
    static const uint16_t WIDTH = 176;
    static const uint16_t HEIGHT = 264;
    static const GxEPD2::Panel panel = GxEPD2::EM027AS012;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = false; // TODO: unknown, verify
    static const bool hasFastPartialUpdate = false; // TODO: unknown, verify

    // TODO: verify below times
    ...
    // constructor
    GxEPD2_270_PD(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
